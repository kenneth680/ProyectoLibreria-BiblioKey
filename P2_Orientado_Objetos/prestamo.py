...
from P2_Orientado_Objetos.usuario import Usuario
from P2_Orientado_Objetos.libro import Libro
...
class Prestamo:
    def __init__(self, usuario: Usuario, libro: Libro, fecha_prestamo: date = None, dias_permitidos: int = None):
        ...
        self._libro = libro
        self._fecha_prestamo = fecha_prestamo if fecha_prestamo is not None else date.today()
    ...
    def calcular_multa(self, tarifa_por_dia: float = 15.0, fecha_referencia: date = None) -> float:
        """Calcula el monto acumulado de la penalización (L15.00 por día de atraso)."""
